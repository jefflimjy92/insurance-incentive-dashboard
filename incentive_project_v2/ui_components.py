...
def render_agent_list_ui(agg_df: pd.DataFrame):
    ...
    for idx, row in agg_df.iterrows():
        ...
        with c1:
            ...
            if row.get('코칭필요'):
                st.markdown("<span style='background:#FEF2F2; color:#DC2626; padding:2px 6px; border-radius:4px; font-size:0.7rem; font-weight:600;'>집중관리필요</span>", unsafe_allow_html=True)
