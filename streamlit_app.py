...
def render_main_controls():
    ...
    with col3:
        ...
        if target_year != st.session_state.shadow_year:
            ...
            # Force rerun to ensure consistency if needed, but selectbox update generally handles it
    ...
    with col4:
        ...
        # index is 0-based, so month 1 is index 0
